...
export function CreditoPill() {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-11 items-center gap-2 rounded-full border border-border-tint bg-surface py-1.5 pl-3 pr-3.5 shadow-card transition-all hover:shadow-card-hover active:scale-[0.98]"
    >
