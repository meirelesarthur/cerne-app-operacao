...
void main() {
  group('RecebimentoXmlFlow', () {
    testWidgets('renderiza sem exceção, botão oculto sem arquivo', (tester) async {
    ...
    testWidgets('avança um passo: selecionar arquivo mostra os itens da nota', (tester) async {
      await tester.pumpWidget(_wrap(const RecebimentoXmlFlow()));
      await tester.pumpAndSettle();
