...
void main() {
  group('DashUso', () {
    testWidgets('renderiza sem exceção e mostra a fazenda expandida por padrão', (tester) async {
    ...
    testWidgets('mostra estado de erro com retry quando offline', (tester) async {
      await setTallSurface(tester);
      ...
      await tester.pumpWidget(
        UncontrolledProviderScope(
          container: container,
          child: MaterialApp(theme: buildAppTheme(AppThemeVariant.light), home: const Scaffold(body: DashUso())),
        ),
      );
      await tester.pumpAndSettle();
