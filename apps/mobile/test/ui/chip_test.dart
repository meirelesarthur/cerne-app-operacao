...
void main() {
  group('AppChip', () {
    ...
    testWidgets('renderiza com ícone e todos os tons sem exceção', (tester) async {
      for (final tone in AppChipTone.values) {
        await tester.pumpWidget(
          _wrap(AppChip(tone: tone, icon: const Icon(LucideIcons.check), child: const Text('Status'))),
        );
