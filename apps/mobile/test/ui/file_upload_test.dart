...
void main() {
  group('AppFileUpload', () {
    testWidgets('estado vazio renderiza a dropzone sem exceções', (tester) async {
    ...
    testWidgets('tocar na dropzone dispara onChanged com um nome de arquivo', (tester) async {
      String? file;
    ...
    testWidgets('com value definido mostra o nome do arquivo e permite remover', (tester) async {
      String? file = 'nota-fiscal.xml';
      await tester.pumpWidget(_wrap(AppFileUpload(value: file, onChanged: (v) => file = v)));
