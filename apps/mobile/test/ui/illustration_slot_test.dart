...
void main() {
  group('AppIllustrationSlot', () {
    testWidgets('renderiza fallback com ícone sem exceções', (tester) async {
      await tester.pumpWidget(_wrap(const AppIllustrationSlot(alt: 'Onboarding', icon: LucideIcons.sprout)));
    ...
    testWidgets('renderiza fallback vazio (sem ícone) sem exceções', (tester) async {
      await tester.pumpWidget(_wrap(const AppIllustrationSlot(alt: 'Estado vazio')));
