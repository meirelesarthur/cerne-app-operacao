...
void main() {
  group('AppSparklineArea', () {
    testWidgets('pinta sem exceções com dados padrão', (tester) async {
      await tester.pumpWidget(_wrap(const AppSparklineArea(data: [1, 5, 3, 8, 4, 9])));
    ...
    testWidgets('aceita cor customizada sem exceções', (tester) async {
      await tester.pumpWidget(_wrap(const AppSparklineArea(data: [1, 5, 3], color: Colors.blue)));
