  ...
  group('AppCheckbox', () {
    testWidgets('renderiza o label sem exceções', (tester) async {
      await tester.pumpWidget(
        _wrap(AppCheckbox(checked: false, onChanged: (_) {}, label: 'Aceito os termos')),
      );
    ...
    testWidgets('dispara onChanged com o valor invertido ao tocar', (tester) async {
      bool? result;
      await tester.pumpWidget(
        _wrap(AppCheckbox(checked: false, onChanged: (v) => result = v, label: 'Marcar')),
      );
