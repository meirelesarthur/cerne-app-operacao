...
void main() {
  ...
  group('appRouter', () {
    ...
    testWidgets('deep-link "/fazendas" mostra as ContextTabs do módulo correto (não as do Início)', (tester) async {
      ...
      expect(find.descendant(of: contextTabs, matching: find.text('Dashboard')), findsOneWidget);
      expect(find.descendant(of: contextTabs, matching: find.text('Financeiro')), findsOneWidget);
