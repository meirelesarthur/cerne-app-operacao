...
final themeVariantProvider = NotifierProvider<ThemeVariantNotifier, AppThemeVariant>(
...
class ThemeVariantNotifier extends Notifier<AppThemeVariant> {
  ...
  void toggle() {
    state = state == AppThemeVariant.light ? AppThemeVariant.gbMode : AppThemeVariant.light;
  }
