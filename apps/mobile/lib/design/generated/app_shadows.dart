...
class AppShadows {
  ...
  static const List<BoxShadow> lg = [
    BoxShadow(color: Color(0x1F000000), offset: Offset(0, 10), blurRadius: 20),
  ];
  static const List<BoxShadow> brand = [
    BoxShadow(color: Color(0x4D059669), offset: Offset(0, 6), blurRadius: 16),
  ];
  static const List<BoxShadow> overlay = [
    BoxShadow(color: Color(0x2E000000), offset: Offset(0, 12), blurRadius: 32),
  ];
  static const List<BoxShadow> modal = [
    BoxShadow(color: Color(0x3D000000), offset: Offset(0, 20), blurRadius: 48),
  ];
  ...
  static const List<BoxShadow> row = [
    BoxShadow(color: Color(0x05000000), offset: Offset(0, 4), blurRadius: 6),
  ];
...
class AppShadowsLight {
  ...
  static const List<BoxShadow> card = [
    BoxShadow(color: Color(0x08101510), offset: Offset(0, 1), blurRadius: 2),
    BoxShadow(color: Color(0x0D101510), offset: Offset(0, 8), blurRadius: 24),
  ];
  static const List<BoxShadow> cardHover = [
    BoxShadow(color: Color(0x1A101510), offset: Offset(0, 10), blurRadius: 30),
  ];
  static const List<BoxShadow> modal = [
    BoxShadow(color: Color(0x3D000000), offset: Offset(0, 20), blurRadius: 48),
  ];
