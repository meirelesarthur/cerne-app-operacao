...
class _OnboardingSlide {
  const _OnboardingSlide({required this.icon, required this.image, required this.title, required this.desc});
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          padding: const EdgeInsets.fromLTRB(AppSpacing.space6, AppSpacing.space10, AppSpacing.space6, AppSpacing.space8),
          child: Column(
            children: [
              Expanded(
                    ...
                    return SingleChildScrollView(
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            AppIllustrationSlot(alt: slide.title, icon: slide.icon, src: slide.image),
                            const SizedBox(height: AppSpacing.space8),
                            AppPageDots(
                              count: _slides.length,
                              active: _slide,
                              onSelect: (i) => _controller.animateToPage(i, duration: const Duration(milliseconds: 250), curve: Curves.easeOut),
                            ),
                            ...
                            ConstrainedBox(
                              ...
                              child: AppHeading(
                                ...
                                child: Text(slide.title, textAlign: TextAlign.center),
                              ),
                            ),
                            ...
                            ConstrainedBox(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(color: semantic.fgMuted, height: 1.4),
                              ),
                            ),
                          ],
                        ),
